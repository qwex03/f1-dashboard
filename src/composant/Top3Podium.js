...
export default function Top3Podium({ top3 }) {
  ...
  return (
    <div className="bg-gradient-to-br from-red-50 to-red-100 dark:from-gray-800 dark:to-gray-900 rounded-3xl shadow-2xl p-6 border border-red-200 dark:border-red-900">
